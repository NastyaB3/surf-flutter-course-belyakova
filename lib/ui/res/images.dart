class Images {
  static String assets = 'res/images/';
  static String icFavorite = '${assets}ic_favorite.svg';
  static String icList = '${assets}ic_list.svg';
  static String icMap = '${assets}ic_map.svg';
  static String icSetting = '${assets}ic_settings.svg';
  static String icShare = '${assets}ic_share.svg';
